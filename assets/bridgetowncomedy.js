...
define('bridgetowncomedy/app', ['exports', 'ember', 'ember-data', 'ember/resolver', 'ember/load-initializers', 'bridgetowncomedy/config/environment'], function (exports, Ember, DS, Resolver, loadInitializers, config) {
  ...
  window.FESTIVAL_START_TIMES = {
    Thursday: "2015-05-07T01:30:00.000Z",
    Friday: "2015-05-08T01:00:00.000Z",
    Saturday: "2015-05-09T20:00:00.000Z",
    Sunday: "2015-05-10T20:00:00.000Z"
  };

  window.FESTIVAL_END_TIMES = {
    Thursday: "2015-05-07T08:30:00.000Z",
    Friday: "2015-05-08T10:00:00.000Z",
    Saturday: "2015-05-09T10:00:00.000Z",
    Sunday: "2015-05-10T08:00:00.000Z"
  };
...
define('bridgetowncomedy/controllers/schedule', ['exports', 'ember'], function (exports, Ember) {
  ...
  exports['default'] = Ember['default'].ObjectController.extend({
    searchField: "",
    actions: {
      filterDay: function filterDay(weekday) {
        this.set("filterWeekday", weekday);
      },
      filterGrid: function filterGrid() {
        Ember['default'].$(".schedule-table").show();
        Ember['default'].$(".schedule-list").hide();
      },
      filterList: function filterList() {
        Ember['default'].$(".schedule-table").hide();
        Ember['default'].$(".schedule-list").show();
      }
    },

    isShowingThursday: Ember['default'].computed.equal("filterWeekday", "thursday"),
    isShowingFriday: Ember['default'].computed.equal("filterWeekday", "friday"),
    isShowingSaturday: Ember['default'].computed.equal("filterWeekday", "saturday"),
    isShowingSunday: Ember['default'].computed.equal("filterWeekday", "sunday"),

    filterWeekday: null,

    isNotFiltered: (function () {
      return !this.get("filterWeekday");
    }).property("filterWeekday"),

    events: (function () {
      var searchRegex = new RegExp(this.searchField, "i");
      var filteredWeekday = this.get("filterWeekday");
      return Ember['default'].ArrayProxy.createWithMixins(Ember['default'].SortableMixin, {
        sortProperties: ["start_time"],
        content: this.get("content.events").filter(function (event) {
          return !filteredWeekday || event.get("weekday") === filteredWeekday;
        }).filter(function (event) {

          // Search through event name for a match
          if (event.get("Name").match(searchRegex)) {
            return true;
          }

          // Search through event Description for a match
          if (event.get("Description").match(searchRegex)) {
            return true;
          }

          // Search through venue name for a match
          if (event.get("venue.Name").match(searchRegex)) {
            return true;
          }

          // Search through performers for a match
          if (event.get("performers").filter(function (p) {
            return p.get("Name").match(searchRegex);
          }).length) {
            return true;
          }
    ...
    }).property("content.events", "filterWeekday", "searchField")
  });

});
define('bridgetowncomedy/controllers/shows', ['exports', 'ember'], function (exports, Ember) {
...
define('bridgetowncomedy/fixtures/event', ['exports'], function (exports) {
  ...
  exports['default'] = [{
    ...
    Cost: "$0",
    ShowId: "",
    Description: "<p>The comedy landscape has undergone tremendous changes in the last ten years, not just with the advent of Twitter, Podcast Networks, Vine, Tumblr, YouTube, Instagram and Facebook, but with how the art form is produced and shared with a broad audience. Digital media has opened up countless avenues for comedians to expand their reach and refine their voice. What are some of the most valuable methods for getting your work out there and building an audience? What are the potential pitfalls of this Brave New World? In this panel discussion, performers are joined by producers and industry reps for an in depth discussion on how digital media and unconventional distribution can assist, and possibly improve, today's generation of comics and writers.</p>\n<p>Panel Members:<br />\nBrian Volk-Weiss : President of Production, NWE/Comedy Dynamics<br />\nJordy Ellner : Senior Director, Talent &amp; Digital Development, Comedy Central<br />\nKesila Childers : Vice President of Digital Media, Bunnim Murray Productions<br />\nAllen Strickland-Williams : Women, Conan<br />\nAndrew Orvedahl and Ben Roy : Grawlix, Those Who Can't</p>\n",
    "iTunes Url": "",
    id: "10383",
    venue: "10374",
    ...
    Cost: "$15",
    ShowId: "",
    Description: "<p>Local sex advice columnist and comedy rockstar Bri Pruett hosts this night of sexy humor featuring comics from all over the country.</p>\n",
    "iTunes Url": "",
    id: "10391",
    venue: "10377",
    ...
    performers: ["9953", "9381", "9144", "9876", "9238", "9979", "9445"],
    emcees: [10189]
  }, {
    EventId: "10392",
    VenueId: "10376",
    ...
    Cost: "$15",
    ShowId: "",
    Description: "<p>Always effervescent, Portland's Veronica Heath hosts this stand-up show featuring festival favorites and exciting new faces.</p>\n",
    "iTunes Url": "",
    id: "10392",
    venue: "10376",
    ...
    Cost: "$10",
    ShowId: "",
    Description: "<p>Head on down to My Father's Place on Grand Ave. for this stand-up showcase featuring a mix of Bridgetown newbies and festival favorites.</p>\n",
    "iTunes Url": "",
    id: "10394",
    venue: "10379",
    start_time: "2015-05-08T03:00:00.000Z",
    end_time: "2015-05-08T04:30:00.000Z",
    pageUrl: "10394-grand-illusions",
    ...
    Cost: "$15",
    ShowId: "10203",
    Description: "<p>Lighthearted, sex-positive and curiosity driven,the Sex Nerd Sandra podcast invites comedians to get down and dirty with a topic from the sex encyclopedia. What will Bridgetown's topic be? Friends with Benefits? Multiple orgasms? Urban dictionary terms? Or Portland's strip club culture? The last time this show graced Portland, it sold out fast, so line up early and think about baseball!</p>\n",
    "iTunes Url": "https://itunes.apple.com/us/podcast/sex-nerd-sandra/id455065811",
    show: "10203",
    id: "10402",
    venue: "10373",
    ...
    Cost: "$30",
    ShowId: "10354",
    Description: "<p>Join Jonathan Katz and special guests for a live production of the groundbreaking animated show Dr. Katz, Professional Therapist. <a href=\"https://www.ticketfly.com/purchase/event/796489\">Tickets</a></p>\n",
    "iTunes Url": "",
    show: "10354",
    id: "10403",
    venue: "10384",
    ...
    Cost: "$20",
    ShowId: "10298",
    Description: "<p>Jackie Kashian discusses favorite obsessions with the obsessed. Video games, Comic Books, Birdwatching. How deep in the dork forest are you? Celebrate it and f*&amp;%$, make it your own!</p>\n",
    "iTunes Url": "https://itunes.apple.com/us/podcast/the-dork-forest/id210939624",
    show: "10298",
    id: "10404",
    venue: "10373",
    ...
    Cost: "$15",
    ShowId: "9240",
    Description: "<p>Hosted by Boston comedian Ken Reid, TV Guidance Counselor is a new podcast about old TV. The premise is, Ken owns every TV Guide from 1980-1995 or so. Someone picks a random TV Guide, writes down everything in it that they want to watch in prime time (8-10pm), and then the podcast is the discussion of their choices.</p>\n",
    "iTunes Url": "https://itunes.apple.com/us/podcast/tv-guidance-counselor-podcast/id821665905",
    show: "9240",
    id: "10405",
    venue: "10373",
    ...
    Cost: "$15",
    ShowId: "10220",
    Description: "<p>Love scientists Amanda Sitko and Eli Newell guide a real dude through three real dates with three real ladies and it gets real weird. The OkCupid Show has been playing to sold out houses at the Upright Citizens Brigade Theater in Los Angeles for the last four years and is finally making its way up to the Great NorthWest.</p>\n",
    "iTunes Url": "",
    show: "10220",
    id: "10406",
    venue: "10373",
    ...
    Cost: "$20",
    ShowId: "10347",
    Description: "<p>Comedian Dana Gould takes a look at our world… through his eyes… for your benefit. Joined by fellow comedians and other interesting people with a focus on the weird and the real. Conversation. Music. Monologues.</p>\n",
    "iTunes Url": "https://itunes.apple.com/us/podcast/the-dana-gould-hour/id499464663",
    show: "10347",
    id: "10407",
    venue: "10373",
    ...
    Cost: "$15",
    ShowId: "",
    Description: "<p>Comics who are educators and/or highly educated present their best material for graduated laughter.</p>\n",
    "iTunes Url": "",
    id: "10411",
    venue: "10380",
    ...
    performers: ["9714", "9839", "9505", "9520", "9484", "9638"],
    emcees: [9353]
  }, {
    EventId: "10412",
    VenueId: "10378",
    ...
    Cost: "$20",
    ShowId: "9710",
    Description: "<p>One part comedy show, two parts drinking game, Brew Haha is an interactive mix of standup comedy and your favorite pre-party ritual. It's Saturday night, drink up.</p>\n",
    "iTunes Url": "",
    show: "9710",
    id: "10412",
    venue: "10378",
    ...
    Cost: "$10",
    ShowId: "",
    Description: "<p>Festival favorites blow the roof off the tent for this late-night standup showcase.</p>\n",
    "iTunes Url": "",
    id: "10416",
    venue: "10380",
    ...
    Cost: "$10",
    ShowId: "",
    Description: "<p>These Bridgetown virgins were staff's favorite during the submission process. Come see which of these teacher's pets is your top pick!</p>\n",
    "iTunes Url": "",
    id: "10417",
    venue: "10380",
    ...
    Cost: "$10",
    ShowId: "",
    Description: "<p>The finest standup-showcase-in-the-back-of-a-burger-joint this side of the Willamette.</p>\n",
    "iTunes Url": "",
    id: "10418",
    venue: "10380",
    ...
    performers: ["9075", "9164", "9799", "9640", "10189", "9238", "9208"],
    emcees: [10031]
  }, {
    EventId: "10419",
    VenueId: "10380",
    ...
    performers: ["9846", "9703", "9787", "9545", "9341", "9114", "9445"],
    emcees: [9382]
  }, {
    EventId: "10420",
    VenueId: "10379",
    ...
    Cost: "$15",
    ShowId: "",
    Description: "<p>Austin, Portland, Brooklyn... we get it. You're weird.</p>\n",
    "iTunes Url": "",
    id: "10420",
    venue: "10379",
    ...
    Cost: "$25",
    ShowId: "10344",
    Description: "<p>Comedians compete writing and performing Erotic Fan Fiction pieces, based upon their whims or audience suggestion. It’s really stupid. And dirty.</p>\n",
    "iTunes Url": "https://itunes.apple.com/us/podcast/competitive-erotic-fan-fiction/id656414997",
    show: "10344",
    id: "10423",
    venue: "10374",
    ...
    Cost: "$25",
    ShowId: "10042",
    Description: "<p>Let comedians Phoebe Robinson &amp; Jessica Williams delight you with this stand up show based on the popular blog of the same name with some of the best comics from around the country.</p>\n",
    "iTunes Url": "",
    show: "10042",
    id: "10425",
    venue: "10373",
    ...
    performers: ["10043", "10233", "9662", "9423", "9114", "9979", "9876"],
    emcees: [10348]
  }, {
    EventId: "10426",
    VenueId: "10375",
    ...
    Cost: "$25",
    ShowId: "10314",
    Description: "<p>Andy chooses from his rolodex (Rolex?) of comedy superstars from LA and around the world (New York) to present a hilarious (his words) and very Particular show. Andy’s the host. It’s his party and he will do time in between each comic if he wants to.</p>\n",
    "iTunes Url": "",
    show: "10314",
    id: "10426",
    venue: "10375",
    ...
    performers: ["9096", "9691", "10346", "10312", "9445", "10349"],
    emcees: [10299]
  }, {
    EventId: "10427",
    VenueId: "10373",
    ...
    Cost: "$20",
    ShowId: "9113",
    Description: "<p>What happens when a comedian doesn't know how the audience is responding? Seven Minutes in Purgatory challenges comedians to perform a seven minute set in a soundproof room while the audience watches a live stream of their set.</p>\n",
    "iTunes Url": "",
    show: "9113",
    id: "10428",
    venue: "10373",
    ...
    performers: ["9093", "9662", "10233", "9564", "10349", "10312", "10299"],
    emcees: [9096]
  }, {
    EventId: "10430",
    VenueId: "10374",
    ...
    Cost: "$20",
    ShowId: "9639",
    Description: "<p>The CrabFeast is a podcast hosted by comedians Ryan Sickler and Jay Larson, with new episodes every Toozdee. Pull up a chair, grab a coupla cold ones and celebrate the things that Ryan and Jay love most — storytelling, family, friends and comedy.</p>\n",
    "iTunes Url": "https://itunes.apple.com/us/podcast/crabfeast-ryan-sickler-jay/id527446250?mt=2",
    show: "9639",
    id: "10430",
    venue: "10374",
    ...
    Cost: "$15",
    ShowId: "",
    Description: "<p>Local funnyman and festival favorite Gabe Dinger hosts a closing show featuring some of the most exciting performers in the fest.</p>\n",
    "iTunes Url": "",
    id: "10432",
    venue: "10377",
    ...
    performers: ["9595", "10134", "10101", "9116", "9770", "9638", "10313"],
    emcees: [9075]
  }, {
    EventId: "10433",
    VenueId: "10374",
    ...
    Cost: "$20",
    ShowId: "10212",
    Description: "<p>Beloved comedian Guy Branum hosts the ultimate test of banter in a thrilling combination of America’s two least respected television formats. Three guests face off to prove who’s the best talk show guest by plugging, name-dropping, and anecdoteing their way to victory.</p>\n",
    "iTunes Url": "",
    show: "10212",
    id: "10433",
    venue: "10374",
    ...
    performers: ["9601", "9739", "10337", "9763", "10341", "10288"],
    emcees: [10210]
  }, {
    EventId: "10436",
    VenueId: "10375",
    ...
    Cost: "$25",
    ShowId: "10319",
    Description: "<p>We are turning over the reins to Kurt and the Norse Hall may never be the same. The only thing we know for sure is Roustabout will be full of surprises so be a part of the show everyone will be talking about tomorrow.</p>\n",
    "iTunes Url": "",
    show: "10319",
    id: "10436",
    venue: "10375",
    ...
    Cost: "$15",
    ShowId: "",
    Description: "<p>These ladies love ladies and you'll love them in this straight-up hilarious showcase.</p>\n",
    "iTunes Url": "",
    id: "10437",
    venue: "10378",
    ...
    Cost: "$10",
    ShowId: "",
    Description: "<p>Witness the magic of Bridgetown as comedians from all over the country take the stage at My Father's Place.</p>\n",
    "iTunes Url": "",
    id: "10442",
    venue: "10379",
    start_time: "2015-05-09T04:30:00.000Z",
    end_time: "2015-05-09T06:00:00.000Z",
    pageUrl: "10442-dads-favorite",
    ...
    Cost: "$5",
    ShowId: "",
    Description: "<p>The infamous Bridgetown Open Mic is back in a new location! You never know who will drop in and if they will stay fully clothed. Be there to witness the birth of Bridgetown legends.</p>\n",
    "iTunes Url": "",
    id: "10445",
    venue: "10379",
    start_time: "2015-05-09T06:00:00.000Z",
    ...
    Cost: "$15",
    ShowId: "",
    Description: "<p>Hey hey it's your birthday! Celebrate the comics who had birthdays during the festival plus many more as we close out the weekend with a bang.</p>\n",
    "iTunes Url": "",
    id: "10448",
    venue: "10378",
    start_time: "2015-05-11T04:00:00.000Z",
    ...
    performers: ["9990", "10082", "10820", "9079", "9979", "10343", "9093", "9876", "10337"],
    emcees: [9790]
  }, {
    EventId: "10449",
    VenueId: "10374",
    ...
    Cost: "$25",
    ShowId: "",
    Description: "<p>An amazing show featuring some of the funniest comics in the festival, who also happen to be women.</p>\n",
    "iTunes Url": "",
    id: "10449",
    venue: "10374",
    start_time: "2015-05-10T02:00:00.000Z",
    ...
    Cost: "$15",
    ShowId: "",
    Description: "<p>Expect the unexpected from this stacked lineup of festival favorites.</p>\n",
    "iTunes Url": "",
    id: "10451",
    venue: "10380",
    start_time: "2015-05-09T04:30:00.000Z",
    ...
    performers: ["10134", "9505", "9324", "10217", "9392", "10044", "9755"],
    emcees: [9787]
  }, {
    EventId: "10453",
    VenueId: "10377",
    ...
    Cost: "$20",
    ShowId: "9933",
    Description: "<p>Heart Of Darkness: a psychedelic showcase of comedy, live music and fringe scientists that has been a frequent Time Out New York critic’s pick, much loved by BrooklynVegan and hailed as ‘Excellent’ by The New Yorker.</p>\n",
    "iTunes Url": "",
    show: "9933",
    id: "10453",
    venue: "10377",
    ...
    Cost: "$15",
    ShowId: "",
    Description: "<p>Get on the wagon with our favorite comics who can always be trusted to tell you what happened last night.</p>\n",
    "iTunes Url": "",
    id: "10455",
    venue: "10377",
    start_time: "2015-05-10T02:00:00.000Z",
    ...
    Cost: "$20",
    ShowId: "10230",
    Description: "<p>Open Mike Eagle is an L.A. based hip-hop artist. On Secret Skin, he and his guests examine what’s really going on behind the face that comics put on for the public. The in-jokes. The heavy stuff. The tour stories. The day-to-day struggles and absurdities of being a working comedian.</p>\n",
    "iTunes Url": "",
    show: "10230",
    id: "10459",
    venue: "10378",
    ...
    Cost: "$20",
    ShowId: "",
    Description: "<p>A divine night of standup culminating in a guided meditation with comedian Laura House.</p>\n",
    "iTunes Url": "",
    id: "10460",
    venue: "10374",
    ...
    Cost: "$25",
    ShowId: "10045",
    Description: "<p>An incredible night of comedy, music, and gunplay hosted by Dave Hill and a surprise house band.</p>\n",
    "iTunes Url": "",
    show: "10045",
    id: "10461",
    venue: "10373",
    ...
    performers: ["10312", "9105", "10233", "10293"],
    emcees: [9167]
  }, {
    EventId: "10466",
    VenueId: "10374",
    ...
    Cost: "$20",
    ShowId: "",
    Description: "<p>Everything that happens on this show is put on a slip of paper, put in a hat, and an audience member pulls one out, and tells us what happens next! Guaranteed to be fun and entertaining. Prizes! Surprises!<br />\nSee it once, SEE IT FOREVER!</p>\n",
    "iTunes Url": "",
    id: "10466",
    venue: "10374",
    start_time: "2015-05-10T06:00:00.000Z",
    ...
    Cost: "$20",
    ShowId: "",
    Description: "<p>A stellar lineup of comedians take the stage for one last hurrah!</p>\n",
    "iTunes Url": "",
    id: "10467",
    venue: "10374",
    start_time: "2015-05-11T04:00:00.000Z",
    ...
    performers: ["10282", "10309", "9990", "10316", "10293", "10313"],
    emcees: [10112]
  }, {
    EventId: "10503",
    VenueId: "10378",
    ...
    Cost: "$20",
    ShowId: "",
    Description: "<p>Guy Branum brings family together for the biggest, gayest, merriest show of the fest.</p>\n",
    "iTunes Url": "",
    id: "10503",
    venue: "10378",
    ...
    Cost: "$25",
    ShowId: "10199",
    Description: "<p>The original Funny Over Everything team is back together again with a blockbuster lineup. One of Portland's best produced shows has some of the nation's best comics.</p>\n",
    "iTunes Url": "",
    show: "10199",
    id: "10672",
    venue: "10375",
    ...
    Cost: "$20",
    ShowId: "10320",
    Description: "<p>A live taping of the K Ohle's GET LOST format. The entire audience will be blindfolded, put on a bus and driven somewhere fantastic they've never been. During the bus ride they'll be entertained by Kurt and a special guest comedian taunting them the whole way. Once at this VERY SECRET LOCATION, they will be un-blindfolded and allowed to explore on their own, while Kurt explains where they are, and why they're there. The entire insane experience should take about 3 hours. Prepare for walking, and possible encounters with dirt and awe. Wear appropriate footwear.</p>\n",
    "iTunes Url": "https://itunes.apple.com/us/podcast/k-ohle-kurt-braunohler/id638820423",
    show: "10320",
    id: "10676",
    venue: "10675",
    start_time: "2015-05-09T21:00:00.000Z",
    ...
    Cost: "$20",
    ShowId: "",
    Description: "<p>Kill Rock Stars picked their favorite comics for this stand up show which is not to be missed!<br />\n*no rock stars were harmed in the making of this show</p>\n",
    "iTunes Url": "",
    id: "10678",
    venue: "10373",
    start_time: "2015-05-09T06:00:00.000Z",
    ...
    Cost: "$20",
    ShowId: "",
    Description: "<p>Walk both sides of the thin blue line with folks who have fought the law, been the law, or at least played the law on TV.</p>\n",
    "iTunes Url": "",
    id: "10706",
    venue: "10374",
    start_time: "2015-05-08T03:00:00.000Z",
    ...
    performers: ["9770", "9439", "9341", "9479", "10341", "9676", "10337"],
    emcees: [9545]
  }, {
    EventId: "10728",
    VenueId: "10377",
    ...
    Cost: "$20",
    ShowId: "",
    Description: "<p>Back! And still Black! The New Negroes returns to attack the wackness mistaken for blackness. We again present a showcase of comedians from around the country that redefine and redesign. Come fux with the redux.</p>\n",
    "iTunes Url": "",
    id: "10728",
    venue: "10377",
    start_time: "2015-05-10T04:00:00.000Z",
    ...
    performers: ["10223", "9978", "9212", "9114", "9243", "9692", "9483", "10043"],
    emcees: [10233]
  }, {
    EventId: "10729",
    VenueId: "10373",
    ...
    performers: ["10025", "9382", "10101", "10214", "9860", "9876", "9787", "9839"],
    emcees: [10233]
  }, {
    EventId: "10731",
    VenueId: "10373",
    ...
    EventId: "10733",
    VenueId: "10377",
    Name: "Steven Wilber's Appropriately-Titled Comedy Show",
    StartTime: "2015-05-07 22:00:00 to 2015-05-07 23:30:00",
    EndTime: "2015-05-07 22:00:00 to 2015-05-07 23:30:00",
    MCId: "9235",
    Cost: "$15",
    ShowId: "",
    Description: "<p>The never predictable but always funny Steven Wilber (Portland's Funniest Person 2014) hosts this purrfect evening of stand-up that will leave you wanting meow.</p>\n",
    "iTunes Url": "",
    id: "10733",
    venue: "10377",
    start_time: "2015-05-08T05:00:00.000Z",
    end_time: "2015-05-08T06:30:00.000Z",
    pageUrl: "10733-steven-wilbers-appropriately-titled-comedy-show",
    ...
    Cost: "$10",
    ShowId: "",
    Description: "<p>A comedy game show where contestants get mad and then get down, because anger and music go together like habanero peppers and ice cream. The rantses and the dances will be judged by a celebrity panel and enjoyed by viewers like you!</p>\n",
    "iTunes Url": "",
    id: "10734",
    venue: "10376",
    start_time: "2015-05-09T06:00:00.000Z",
    ...
    Cost: "$20",
    ShowId: "11014",
    Description: "<p>The Imaginary Radio Program combines live music and beat-boxing with one-man sketches into a show that the Los Angeles Comedy Bureau writes, \"Not only lives up to its name, but exceeds expectation in what you could possibly think it is.\"</p>\n",
    "iTunes Url": "",
    show: "11014",
    id: "10736",
    venue: "10374",
    ...
    Cost: "$30",
    ShowId: "11000",
    Description: "<p>Self destructive writer Dan Harmon (\"Community,\" \"Rick and Morty,\" \"Heat Vision and Jack\") claims he will one day found a colony of like-minded misfits. He's appointed suit-clad gadabout Jeff Davis (\"Whose Line is it Anyway?\") as his Comptroller.</p>\n",
    "iTunes Url": "https://itunes.apple.com/us/podcast/harmontown/id542228532?mt=2",
    show: "11000",
    id: "10737",
    venue: "10374",
    ...
    performers: ["10342", "10816", "10299", "10337"],
    emcees: [10346]
  }, {
    EventId: "10741",
    VenueId: "10384",
    ...
    Cost: "$15",
    ShowId: "",
    Description: "<p>Portland's delightful Amy Miller brings you a night of stand-up so sweet it'll hurt your teeth.</p>\n",
    "iTunes Url": "",
    id: "10749",
    venue: "10376",
    ...
    Cost: "$0",
    ShowId: "9781",
    Description: "<p>What happens when you cross a comedy show with a 1920's speakeasy? Find out at the Nickel Club, where a jazz band and the gorgeous copper still of the New Deal Distillery set the mood for a night of exceptional stand up. Join Comedy and Cocktails' favorite duo Jason Traeger and Brandy Feit along with host Brad Silnutzer and some Bridgetown favorites for this very special event.</p>\n",
    "iTunes Url": "",
    show: "9781",
    id: "10758",
    venue: "10677",
    ...
    performers: ["9079", "10192", "9978", "11045", "9827", "9640", "10119", "9739", "10337"],
    emcees: [9714]
  }, {
    EventId: "10764",
    VenueId: "10763",
    ...
    Cost: "$15",
    ShowId: "",
    Description: "<p>Jackie Kashian headlines this amazing show at Guardian Games full of performers who love games as much as they love comedy.</p>\n",
    "iTunes Url": "",
    id: "10764",
    venue: "10763",
    ...
    Cost: "$15",
    ShowId: "",
    Description: "<p>Local favorite and Portland's Funniest Person winner Nathan Brannon hosts a stand-up showcase featuring awesome comics from around the country.</p>\n",
    "iTunes Url": "",
    id: "10765",
    venue: "10377",
    start_time: "2015-05-11T02:00:00.000Z",
    ...
    Cost: "$20",
    ShowId: "",
    Description: "<p>This is where it all starts! Come see some of our favorite faces at our premiere venue.</p>\n",
    "iTunes Url": "",
    id: "10766",
    venue: "10373",
    start_time: "2015-05-08T02:00:00.000Z",
    ...
    Cost: "$15",
    ShowId: "",
    Description: "<p>A night of 1000 laughs with some of Bridgetown's finest comedians.</p>\n",
    "iTunes Url": "",
    id: "10783",
    venue: "10376",
    start_time: "2015-05-09T04:00:00.000Z",
    ...
    performers: ["10181", "9846", "10031", "9177", "9326", "9919", "9105", "9479"],
    emcees: [9977]
  }, {
    EventId: "10784",
    VenueId: "10378",
    ...
    Cost: "$5",
    ShowId: "",
    Description: "<p>A celebration of breakfast sandwiches in honor of yo momma. Champagne encouraged.</p>\n",
    "iTunes Url": "",
    id: "10788",
    venue: "10380",
    start_time: "2015-05-10T22:00:00.000Z",
    ...
    performers: ["10181", "9703", "9978", "9787", "9243", "10119", "10315"],
    emcees: [10820]
  }, {
    EventId: "10817",
    VenueId: "10373",
    ...
    performers: ["9427", "9280", "10082", "10343", "9238", "9676", "10296", "10816"],
    emcees: [9660]
  }, {
    EventId: "10998",
    VenueId: "10379",
    ...
    Cost: "$5",
    ShowId: "",
    Description: "<p>The infamous Bridgetown Open Mic is back in a new location! You never know who will drop in and who will drop trou. Be there to witness the birth of Bridgetown legends.</p>\n",
    "iTunes Url": "",
    id: "10998",
    venue: "10379",
    start_time: "2015-05-08T05:00:00.000Z",
    ...
    StartTime: "2015-06-12 19:30:00 to 2015-06-12 21:30:00",
    EndTime: "2015-06-12 19:30:00 to 2015-06-12 21:30:00",
    MCId: "10192",
    Cost: "",
    ShowId: "11107",
    Description: "",
    ...
    id: "11108",
    venue: "10677",
    start_time: "2015-06-13T02:30:00.000Z",
    end_time: "2015-06-13T04:30:00.000Z",
    pageUrl: "11108-comedy-and-cocktails",
    performers: ["11045"],
    emcees: [10192]
  }];
...
define('bridgetowncomedy/fixtures/show', ['exports'], function (exports) {
  ...
  exports['default'] = [{
    ...
    Name: "Harmontown",
    Copy: "Self-destructive writer Dan Harmon (&quot;Community,&quot; &quot;Rick and Morty,&quot; &quot;Heat Vision and Jack&quot;) claims he will one day found a colony of like-minded misfits. He&#039;s appointed suit-clad gadabout Jeff Davis (&quot;Whose Line is it Anyway?&quot;) as his Comptroller.",
    ...
    SortOrder: 2,
    iTunesUrl: "https://itunes.apple.com/us/podcast/harmontown/id542228532?mt=2",
    events: ["10737"]
  }, {
    Name: "Baked",
    ...
    SortOrder: 8,
    iTunesUrl: "https://itunes.apple.com/us/podcast/crabfeast-ryan-sickler-jay/id527446250?mt=2",
    events: ["10430"]
  }, {
    Name: "Competitive Erotic Fan Fiction",
    ...
    SortOrder: 9,
    iTunesUrl: "https://itunes.apple.com/us/podcast/competitive-erotic-fan-fiction/id656414997",
    events: ["10423"]
  }, {
    Name: "The K Ohle with Kurt Braunohler",
    Copy: "A live taping of the K Ohle&#039;s GET LOST format. The entire audience will be blindfolded, put on a bus and driven somewhere fantastic they&#039;ve never been. During the bus ride they&#039;ll be entertained by Kurt and a special guest comedian taunting them the whole way. Once at this VERY SECRET LOCATION, they will be un-blindfolded and allowed to explore on their own, while Kurt explains where they are, and why they&#039;re there. The entire insane experience should take about 3 hours. Prepare for walking, and possible encounters with dirt and awe. Wear appropriate footwear.",
    Bio: "A live taping of the K Ohle&#039;s GET LOST format. The entire audience will be blindfolded, put on a bus and driven somewhere fantastic they&#039;ve never been. During the bus ride they&#039;ll be entertained by Kurt and a special guest comedian taunting them the whole way. Once at this VERY SECRET LOCATION, they will be un-blindfolded and allowed to explore on their own, while Kurt explains where they are, and why they&#039;re there. The entire insane experience should take about 3 hours. Prepare for walking, and possible encounters with dirt and awe.\r\n",
    ...
    SortOrder: 10,
    iTunesUrl: "https://itunes.apple.com/us/podcast/k-ohle-kurt-braunohler/id638820423",
    events: ["10676"]
  }, {
    Name: "Blaria",
    ...
    SortOrder: 12,
    iTunesUrl: "https://itunes.apple.com/us/podcast/the-dork-forest/id210939624",
    events: ["10404"]
  }, {
    Name: "The Dana Gould Hour",
    ...
    SortOrder: 13,
    iTunesUrl: "https://itunes.apple.com/us/podcast/the-dana-gould-hour/id499464663",
    events: ["10407"]
  }, {
    Name: "Funny Over Everything",
    ...
    SortOrder: 19,
    iTunesUrl: "https://itunes.apple.com/us/podcast/probably-science/id497735695",
    events: ["10401"]
  }, {
    Name: "Sex Nerd Sandra",
    ...
    "iTunes Url": "https://itunes.apple.com/us/podcast/sex-nerd-sandra/id455065811",
    id: "10203",
    pageUrl: "10203-sex-nerd-sandra",
    SortOrder: 20,
    iTunesUrl: "https://itunes.apple.com/us/podcast/sex-nerd-sandra/id455065811",
    events: ["10402"]
  }, {
    Name: "The OkCupid Show",
    ...
    "iTunes Url": "",
    id: "9781",
    pageUrl: "9781-comedy-and-cocktails-presents-the-nickel-club",
    SortOrder: 27,
    iTunesUrl: "",
    events: ["10758"]
  }, {
    ...
    SortOrder: 28,
    iTunesUrl: "https://itunes.apple.com/us/podcast/tv-guidance-counselor-podcast/id821665905",
    events: ["10405"]
  }, {
    Name: "Comedy and Cocktails",
...
define('bridgetowncomedy/helpers/get-weekday', ['exports', 'ember'], function (exports, Ember) {
  ...
  function getWeekday(dateString) {
    return moment(dateString.toString()).utcOffset("-07:00").format("dddd");
  }
...
define('bridgetowncomedy/helpers/schedule-table-header-row', ['exports', 'ember'], function (exports, Ember) {

  'use strict';

  exports.scheduleTableHeaderRow = scheduleTableHeaderRow;
  ...
  function getTimeArray(day) {
    ...
    var timeArray = [];
    var duration = moment(window.FESTIVAL_END_TIMES[day]).diff(window.FESTIVAL_START_TIMES[day], "hours");
    for (var i = 0; i < duration * 2; i++) {
      timeArray.push(moment(window.FESTIVAL_START_TIMES[day]).add(i * 30, "minutes"));
    }
    return timeArray;
  }
  function scheduleTableHeaderRow(day) {
    var html = "<th>Venue</th>";
    var timeArray = getTimeArray(day);
    Ember['default'].$.each(timeArray, function (index, time) {
      var $el = Ember['default'].$("<tr><th class=\"schedule-table__time-header\" data-start-time=\"" + time.toISOString() + "\">" + time.format("MM/DD ") + "<br />" + time.format("h:mm a") + "</th></tr>");
      html += $el.html();
    });
    return new Ember['default'].Handlebars.SafeString(html);
  }

  exports['default'] = Ember['default'].HTMLBars.makeBoundHelper(scheduleTableHeaderRow);
...
define('bridgetowncomedy/initializers/trackerrors', ['exports', 'ember'], function (exports, Ember) {
...
define('bridgetowncomedy/models/event', ['exports', 'ember-data'], function (exports, DS) {
  ...
  var EventModel = DS['default'].Model.extend({
    ...
    weekday: (function () {
      return moment(this.get("start_time")).utcOffset(-7).format("dddd").toLowerCase();
    }).property("start_time"),
...
define('bridgetowncomedy/models/show', ['exports', 'ember-data'], function (exports, DS) {
  ...
  var Show = DS['default'].Model.extend({
    ...
    iTunesUrl: DS['default'].attr("string"),
...
define('bridgetowncomedy/routes/schedule_grid', ['exports', 'ember'], function (exports, Ember) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        var morph7 = dom.createMorphAt(element4,3,4);
        ...
        block(env, morph5, context, "if", [get(env, context, "show")], {}, child1, child2);
        block(env, morph6, context, "each", [get(env, context, "model.performers")], {"keyword": "performer"}, child3, null);
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        var morph1 = dom.createMorphAt(dom.childAt(fragment, [3]),0,1);
        inline(env, morph0, context, "schedule-table-header-row", ["Friday"], {});
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        var morph0 = dom.createUnsafeMorphAt(dom.childAt(fragment, [1, 1]),2,3);
        var morph1 = dom.createMorphAt(dom.childAt(fragment, [3]),0,1);
        inline(env, morph0, context, "schedule-table-header-row", ["Saturday"], {});
        block(env, morph1, context, "each", [get(env, context, "controller.venues")], {"keyword": "venue"}, child0, null);
        return fragment;
      }
    };
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        var morph0 = dom.createUnsafeMorphAt(dom.childAt(fragment, [1, 1]),2,3);
        var morph1 = dom.createMorphAt(dom.childAt(fragment, [3]),0,1);
        inline(env, morph0, context, "schedule-table-header-row", ["Thursday"], {});
        block(env, morph1, context, "each", [get(env, context, "controller.venues")], {"keyword": "venue"}, child0, null);
        return fragment;
      }
    };
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      build: function build(dom) {
        ...
        var el5 = dom.createElement("a");
        dom.setAttribute(el5,"target","_blank");
        dom.setAttribute(el5,"href","http://www.audible.com/");
        var el6 = dom.createElement("img");
        dom.setAttribute(el6,"class","img-responsive");
        dom.setAttribute(el6,"src","/img/sponsor-images/sponsor-audible.png?1");
        dom.setAttribute(el6,"alt","");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n      ");
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        var morph6 = dom.createMorphAt(dom.childAt(element1, [3, 1]),-1,0);
        var morph7 = dom.createMorphAt(element5,0,1);
        var morph8 = dom.createMorphAt(element5,1,2);
        ...
        block(env, morph6, context, "link-to", ["venue", get(env, context, "venue.pageUrl")], {}, child2, null);
        block(env, morph7, context, "each", [get(env, context, "sortedPerformers")], {"keyword": "performer"}, child3, null);
        block(env, morph8, context, "each", [get(env, context, "emcees")], {"keyword": "emcee"}, child4, null);
        return fragment;
      }
    };
  }()));
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        block(env, morph1, context, "each", [get(env, context, "controller")], {"keyword": "performer"}, child0, child1);
        return fragment;
      }
    };
  }()));
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    var child0 = (function() {
      var child0 = (function() {
        return {
          ...
          build: function build(dom) {
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("p");
            var el2 = dom.createTextNode(" events found:");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n");
            dom.appendChild(el0, el1);
          ...
          render: function render(context, env, contextualElement) {
            ...
            content(env, morph0, context, "controller.events.length");
            return fragment;
          }
        };
      }());
      var child1 = (function() {
        return {
          ...
          build: function build(dom) {
            ...
            dom.appendChild(el0, el1);
            var el1 = dom.createElement("p");
            var el2 = dom.createTextNode("No events found:");
            dom.appendChild(el1, el2);
            dom.appendChild(el0, el1);
            var el1 = dom.createTextNode("\n");
            dom.appendChild(el0, el1);
      ...
      return {
        ...
        render: function render(context, env, contextualElement) {
          ...
          if (this.cachedFragment) { dom.repairClonedNode(fragment,[0,1]); }
          var morph0 = dom.createMorphAt(fragment,0,1,contextualElement);
          block(env, morph0, context, "if", [get(env, context, "controller.events.length")], {}, child0, child1);
          return fragment;
        }
      };
    }());
    ...
    return {
      ...
      build: function build(dom) {
        ...
        var el4 = dom.createTextNode("Prices and times subject to change...");
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n\n\n\n  ");
        dom.appendChild(el2, el3);
        ...
        dom.setAttribute(el7,"class","col-xs-12 col-sm-3");
        var el8 = dom.createTextNode("\n            ");
        dom.appendChild(el7, el8);
        var el8 = dom.createElement("p");
        var el9 = dom.createElement("button");
        dom.setAttribute(el9,"type","button");
        dom.setAttribute(el9,"class","btn btn-primary btn-block");
        var el10 = dom.createTextNode("Show All Days");
        ...
        dom.appendChild(el6, el7);
        var el7 = dom.createElement("div");
        dom.setAttribute(el7,"class","col-xs-6 col-sm-2 col-sm-offset-1");
        var el8 = dom.createTextNode("\n            ");
        dom.appendChild(el7, el8);
        var el8 = dom.createElement("p");
        var el9 = dom.createElement("button");
        dom.setAttribute(el9,"type","button");
        dom.setAttribute(el9,"class","btn btn-primary btn-block");
        var el10 = dom.createTextNode("Thursday");
        dom.appendChild(el9, el10);
        dom.appendChild(el8, el9);
        dom.appendChild(el7, el8);
        var el8 = dom.createTextNode("\n          ");
        ...
        dom.appendChild(el6, el7);
        var el7 = dom.createElement("div");
        dom.setAttribute(el7,"class","col-xs-6 col-sm-2");
        var el8 = dom.createTextNode("\n            ");
        dom.appendChild(el7, el8);
        var el8 = dom.createElement("p");
        var el9 = dom.createElement("button");
        dom.setAttribute(el9,"type","button");
        dom.setAttribute(el9,"class","btn btn-primary  btn-block");
        var el10 = dom.createTextNode("Friday");
        dom.appendChild(el9, el10);
        dom.appendChild(el8, el9);
        dom.appendChild(el7, el8);
        var el8 = dom.createTextNode("\n          ");
        ...
        dom.setAttribute(el9,"type","button");
        dom.setAttribute(el9,"class","btn btn-primary  btn-block");
        var el10 = dom.createTextNode("Saturday");
        dom.appendChild(el9, el10);
        dom.appendChild(el8, el9);
        dom.appendChild(el7, el8);
        var el8 = dom.createTextNode("\n          ");
        ...
        dom.setAttribute(el9,"type","button");
        dom.setAttribute(el9,"class","btn btn-primary  btn-block");
        var el10 = dom.createTextNode("Sunday");
        dom.appendChild(el9, el10);
        dom.appendChild(el8, el9);
        dom.appendChild(el7, el8);
        var el8 = dom.createTextNode("\n          ");
        ...
        dom.appendChild(el6, el7);
        var el7 = dom.createElement("div");
        dom.setAttribute(el7,"class","col-md-4 col-md-offset-8 col-sm-6 col-sm-offset-6 col-xs-12");
        var el8 = dom.createTextNode("\n                ");
        dom.appendChild(el7, el8);
        var el8 = dom.createElement("p");
        var el9 = dom.createElement("label");
        var el10 = dom.createTextNode("Search events:");
        dom.appendChild(el9, el10);
        dom.appendChild(el8, el9);
      ...
      render: function render(context, env, contextualElement) {
        ...
        var element4 = dom.childAt(element1, [5, 1, 0]);
        var element5 = dom.childAt(element1, [7, 1, 0]);
        var element6 = dom.childAt(element1, [9, 1, 0]);
        var element7 = dom.childAt(element0, [3, 1]);
        var morph0 = dom.createMorphAt(fragment,0,1,contextualElement);
        var morph1 = dom.createMorphAt(dom.childAt(element7, [1]),1,-1);
        var morph2 = dom.createMorphAt(element7,2,3);
        var morph3 = dom.createMorphAt(dom.childAt(element0, [5, 1, 1]),0,1);
        inline(env, morph0, context, "page-title-banner", [], {"title": "Schedule"});
        element(env, element2, context, "action", ["filterDay", get(env, context, "null")], {});
        element(env, element2, context, "bind-attr", [], {"disabled": get(env, context, "isNotFiltered")});
        element(env, element3, context, "action", ["filterDay", "thursday"], {});
        element(env, element3, context, "bind-attr", [], {"disabled": get(env, context, "isShowingThursday")});
        element(env, element4, context, "action", ["filterDay", "friday"], {});
        element(env, element4, context, "bind-attr", [], {"disabled": get(env, context, "isShowingFriday")});
        element(env, element5, context, "action", ["filterDay", "saturday"], {});
        element(env, element5, context, "bind-attr", [], {"disabled": get(env, context, "isShowingSaturday")});
        element(env, element6, context, "action", ["filterDay", "sunday"], {});
        element(env, element6, context, "bind-attr", [], {"disabled": get(env, context, "isShowingSunday")});
        inline(env, morph1, context, "input", [], {"value": get(env, context, "searchField"), "classNames": "form-control"});
        block(env, morph2, context, "if", [get(env, context, "searchField")], {}, child0, child1);
        inline(env, morph3, context, "cloaked-collection", [], {"cloakView": "schedule-list-item", "content": get(env, context, "controller.events"), "preservesContext": true, "defaultHeight": 218, "slackRatio": 3});
        return fragment;
      }
    };
  }()));
...
define('bridgetowncomedy/templates/schedule_grid', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      build: function build(dom) {
        ...
        dom.setAttribute(el3,"class","schedule-table");
        var el4 = dom.createTextNode("\n  ");
        dom.appendChild(el3, el4);
        ...
        var el7 = dom.createTextNode("Venue");
        dom.appendChild(el6, el7);
        dom.appendChild(el5, el6);
        var el6 = dom.createTextNode("\n  ");
        dom.appendChild(el5, el6);
      ...
      render: function render(context, env, contextualElement) {
        ...
        var morph0 = dom.createUnsafeMorphAt(dom.childAt(element4, [1, 1]),2,3);
        var morph1 = dom.createMorphAt(dom.childAt(element4, [3]),0,1);
        element(env, element3, context, "bind-attr", [], {"class": "scheduleClass"});
        inline(env, morph0, context, "schedule-table-header-row", ["Thursday"], {});
        block(env, morph1, context, "each", [get(env, context, "controller.venues")], {"keyword": "venue"}, child0, null);
        return fragment;
      }
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    var child0 = (function() {
      return {
        ...
        build: function build(dom) {
          ...
          dom.setAttribute(el3,"src","/img/itunes-badge.png");
          dom.appendChild(el2, el3);
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode("\n      ");
          dom.appendChild(el1, el2);
        ...
        render: function render(context, env, contextualElement) {
          ...
          element(env, element0, context, "bind-attr", [], {"href": get(env, context, "iTunesUrl")});
          return fragment;
        }
      };
    }());
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        var morph0 = dom.createMorphAt(fragment,0,1,contextualElement);
        var morph1 = dom.createUnsafeMorphAt(dom.childAt(element3, [1]),0,1);
        var morph2 = dom.createMorphAt(element3,2,3);
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      build: function build(dom) {
        ...
        var el4 = dom.createElement("a");
        dom.setAttribute(el4,"target","_blank");
        dom.setAttribute(el4,"href","http://www.audible.com/");
        var el5 = dom.createElement("img");
        dom.setAttribute(el5,"class","img-responsive");
        dom.setAttribute(el5,"src","/img/sponsor-images/sponsor-audible.png?1");
        dom.setAttribute(el5,"alt","");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n    ");
        ...
        var el4 = dom.createElement("a");
        dom.setAttribute(el4,"target","_blank");
        dom.setAttribute(el4,"href","http://xray.fm/");
        var el5 = dom.createElement("img");
        dom.setAttribute(el5,"class","img-responsive");
        dom.setAttribute(el5,"src","/img/sponsor-images/sponsor-x-ray.png");
        dom.setAttribute(el5,"alt","");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n    ");
        ...
        var el4 = dom.createElement("a");
        dom.setAttribute(el4,"target","_blank");
        dom.setAttribute(el4,"href","http://www.cogojuice.com/");
        var el5 = dom.createElement("img");
        dom.setAttribute(el5,"class","img-responsive");
        dom.setAttribute(el5,"src","/img/sponsor-images/sponsor-columbia-gorge.png");
        dom.setAttribute(el5,"alt","");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n    ");
        ...
        var el4 = dom.createElement("a");
        dom.setAttribute(el4,"target","_blank");
        dom.setAttribute(el4,"href","http://shirtnerdery.com/");
        var el5 = dom.createElement("img");
        dom.setAttribute(el5,"class","img-responsive");
        dom.setAttribute(el5,"src","/img/sponsor-images/sponsor-t-shirt-nerdery.png");
        dom.setAttribute(el5,"alt","");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n    ");
        ...
        var el4 = dom.createElement("a");
        dom.setAttribute(el4,"target","_blank");
        dom.setAttribute(el4,"href","http://www.purringtonscatlounge.com/");
        var el5 = dom.createElement("img");
        dom.setAttribute(el5,"class","img-responsive");
        dom.setAttribute(el5,"src","/img/sponsor-images/sponsor-purringtons.png");
        dom.setAttribute(el5,"alt","");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n    ");
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        inline(env, morph0, context, "page-title-banner", [], {"title": get(env, context, "model.Name")});
        inline(env, morph1, context, "google-map-link", [get(env, context, "address")], {});
...
define('bridgetowncomedy/tests/controllers/schedule.jshint', function () {

  'use strict';

  module('JSHint - controllers');
  test('controllers/schedule.js should pass jshint', function() { 
    ok(true, 'controllers/schedule.js should pass jshint.'); 
  });

});
define('bridgetowncomedy/tests/controllers/shows.jshint', function () {

  'use strict';

  module('JSHint - controllers');
  test('controllers/shows.js should pass jshint', function() { 
    ok(true, 'controllers/shows.js should pass jshint.'); 
  });
...
define('bridgetowncomedy/tests/helpers/schedule-table-header-row.jshint', function () {

  'use strict';

  module('JSHint - helpers');
  test('helpers/schedule-table-header-row.js should pass jshint', function() { 
    ok(true, 'helpers/schedule-table-header-row.js should pass jshint.'); 
  });
...
define('bridgetowncomedy/tests/initializers/trackerrors.jshint', function () {

  'use strict';

  module('JSHint - initializers');
  test('initializers/trackerrors.js should pass jshint', function() { 
    ok(true, 'initializers/trackerrors.js should pass jshint.'); 
  });
...
define('bridgetowncomedy/tests/routes/schedule_grid.jshint', function () {

  'use strict';

  module('JSHint - routes');
  test('routes/schedule_grid.js should pass jshint', function() { 
    ok(true, 'routes/schedule_grid.js should pass jshint.'); 
  });
...
define('bridgetowncomedy/tests/unit/helpers/schedule-table-header-row-test', ['bridgetowncomedy/helpers/schedule-table-header-row', 'qunit'], function (schedule_table_header_row, qunit) {

  'use strict';

  qunit.module("ScheduleTableHeaderRowHelper");

  // Replace this with your real tests.
  qunit.test("it works", function (assert) {
    var result = schedule_table_header_row.scheduleTableHeaderRow(42);
    assert.ok(result);
  });

});
define('bridgetowncomedy/tests/unit/helpers/schedule-table-header-row-test.jshint', function () {

  'use strict';

  module('JSHint - unit/helpers');
  test('unit/helpers/schedule-table-header-row-test.js should pass jshint', function() { 
    ok(true, 'unit/helpers/schedule-table-header-row-test.js should pass jshint.'); 
  });
...
define('bridgetowncomedy/tests/views/schedule_grid.jshint', function () {

  'use strict';

  module('JSHint - views');
  test('views/schedule_grid.js should pass jshint', function() { 
    ok(true, 'views/schedule_grid.js should pass jshint.'); 
  });
...
define('bridgetowncomedy/views/schedule_grid', ['exports', 'ember'], function (exports, Ember) {
  ...
  exports['default'] = Ember['default'].View.extend({
    ...
    addTableColspans: (function () {
      ...
      Ember['default'].$(".cell-spacer").remove();
      Ember['default'].$(".schedule-table__cell").each(function () {
        var startTime = Ember['default'].$(this).data("start-time");
        var endTime = Ember['default'].$(this).data("end-time");
        var duration = moment(endTime).diff(moment(startTime), "minutes") / 30;
        Ember['default'].$(this).attr("colspan", duration);

        var previousTime = Ember['default'].$(this).prevAll(".schedule-table__cell:eq(0)").data("end-time") || window.FESTIVAL_START_TIMES[scheduleDay];
        var durationBefore = moment(startTime).diff(moment(previousTime), "minutes") / 30;
        if (durationBefore <= 0) {
          return;
        }
        Ember['default'].$(this).before("<td class=\"cell-spacer\" colspan=\"" + durationBefore + "\" style=\"border:1px solid white;\"></td>");
      });
    }).on("didInsertElement")
  });
